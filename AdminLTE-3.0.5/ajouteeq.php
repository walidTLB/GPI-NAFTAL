  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ajouter un equipement</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <?php
      ...
      if(isset($_POST['submit']))
       { 
          ...
          if(  $num_equipement&& $description && $t_equipement && $marque && $nom_equipement  )
          {
             $conn =new mysqli('localhost','root','','naftal2');
            
          
            $query =("INSERT INTO `equipment` (`num_eq`, `nom_eq`, `quantite`, `num_tyequi`, `num_mar`) VALUES ('$num_equipement', '$nom_equipement', '$description', '$t_equipement', '$marque');");
...
<form method="post" action="">
    ...
    <div class="modal-footer" >
        <label>nom equipement:
           <input type="text"  name="nom_equipement" placeholder="entrez le nom equipement" >
        </label>
    </div>
    <div class="modal-footer">
        <label>quantitè:
           <input type="text"  name="quantite" placeholder="entrez la quantitè " >
        </label>
    </div>
       <br>
       <div class="modal-footer">
