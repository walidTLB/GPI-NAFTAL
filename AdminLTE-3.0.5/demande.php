...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="acuil3.php" role="button"><i class="fas fa-bars"></i></a>
      </li>
...
<body>
  ...
  <div class="box_dem ">
    ...
    <input type="text" name="nom" placeholder="votre site ..." required="required"><br>
     <label for="site">prenom:</label>
    <input type="text" name="prenom" placeholder="votre site ..." required="required"><br>
     <label for="site">structure:</label>
    <input type="text" name="structure" placeholder="votre site ..." required="required"><br>
     <label for="site">fonction:</label>
    <input type="text" name="fonction" placeholder="votre " required="required"><br>
...
<a type="submit" href="acuil3.php" class="btn btn-danger" name= "annuler">annuler</a>
</body>
</html>
