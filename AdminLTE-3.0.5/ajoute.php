...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="acuil.php" class="brand-link">
      <img src="bg.png" alt="NAFTAL" class="brand-image "style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ajouter un employe</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<body>
 <div class="p-3 mb-2 bg-dark text-white" class = "from-groupe">*AJOUTER UN EMPLOYE*</div>
<br>
...
<form method="post" action="">
  <?php
      ...
      if(isset($_POST['submit']))
       { 
          ...
          if($num_utili && $username && $nom && $prenom &&  $mp && $code_str &&  $fonction  )
          {
            ...
            $query=("INSERT INTO `utilisateur` (`num_utili`, `username`, `nom`, `prenom`, `mp`, `code_str`, `fonction`) VALUES ('$num_utili', '$username', '$nom', '$prenom', Password('$mp') , '$code_str', '$fonction');");
   ...
   <button type="submit" class="btn btn-primary" name = "submit" > ajouter l'employe</button>
</form>
</div>
</body>
</html>  </div>
