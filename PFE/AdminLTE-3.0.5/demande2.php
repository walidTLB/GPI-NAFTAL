...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="acuil2.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="acuil2.php" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                  <a href="./acuil2.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">demande d'intervention</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="acuil2.php">Home</a></li>
...
<body>
   <form method="post" action = "fichinter.php">
  <div class="box_dem ">
    <div class= "form_groupe">
       <label for="site">nom :</label>
    <input type="text" name="nom" placeholder="votre nom" required="required"><br>
     <label for="site">prenom:</label>
    <input type="text" name="prenom" placeholder="votre prenom" required="required"><br>
     <label for="site">structure:</label>
    <input type="text" name="structure" placeholder="votre structure" required="required"><br>
     <label for="site">fonction:</label>
    <input type="text" name="fonction" placeholder="votre fonction" required="required"><br>
